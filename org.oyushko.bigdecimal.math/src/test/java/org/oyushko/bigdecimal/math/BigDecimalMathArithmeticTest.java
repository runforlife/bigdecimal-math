...
import static org.oyushko.bigdecimal.math.BigDecimalMathTest.assertThrows;
import static org.junit.Assert.assertEquals;

public class BigDecimalMathArithmeticTest extends AbstractBigDecimalTest {
    ...
    public void testAddRandom(int count) {
    ...
    public void testSubtractRandom() {
        testSubtractRandom(10000);
    }

    public void testSubtractRandom(int count) {
        assertRandomCalculation(
                adaptCount(count),
                "subtract",
                random -> random.nextDouble() * 100 - 50,
                random -> random.nextDouble() * 100 - 50,
                (x, y) -> x - y,
                BigDecimalMath::subtract);
    }

    @Test
    public void testMultiplyRandom() {
        testMultiplyRandom(10000);
    }

    public void testMultiplyRandom(int count) {
        assertRandomCalculation(
                adaptCount(count),
                "multiply",
                random -> random.nextDouble() * 100 - 50,
    ...
    public void testDivideRandom() {
        testDivideRandom(10000);
    }

    public void testDivideRandom(int count) {
        assertRandomCalculation(
                adaptCount(count),
                "multiply",
                random -> random.nextDouble() * 100 - 50,
