...
public class BigDecimalMathExample {
	...
	public static void exampleForDocu() {
		...
		System.out.println("  convertToFraction(0.45...)   = " + BigDecimalMath.convertToFraction(new BigDecimal("0.789012345678"), new BigDecimal("99999999999999999999"), new BigDecimal("99999999999999999999"), 12, mathContext));
		System.out.println();
